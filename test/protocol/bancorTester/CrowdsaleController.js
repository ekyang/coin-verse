...
const crowdsaleControllerTestCase = (artifact) => {
  // const CrowdsaleController = artifacts.require('CrowdsaleController.sol')
  const CrowdsaleController = artifact
...
// used by contribution tests, creates a controller that's already in progress
  ...
  contract(`${artifact.contractName} is CrowdsaleController`, accounts => {
    before(async () => {
